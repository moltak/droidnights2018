...
import com.droidknights.droidtest.step6.Step6Activity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        clicks(activity_main_step_6).subscribe { buttonRelay.accept(activity_main_step_6) }
                ...
                buttonRelay.throttleFirst(500, TimeUnit.MILLISECONDS)
                        ...
                        .subscribe {
                            val activity = when (it.id) {
                                ...
                                R.id.activity_main_step_6 -> Intent(this, Step6Activity::class.java)
